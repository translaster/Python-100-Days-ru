...
> **Автор**: Луо Хао
>
> **Примечание**: Если доступ к GitHub медленный, вы можете следить за моим номером Zhihu ([**Python-Jack**](https://www.zhihu.com/people/jackfrued)), над колонкой [«**Learning Python from Scratch**»](<https://www.zhihu.com/people/jackfrued>) (соответствует первым 20 дням этого проекта). «]](<https://zhuanlan.zhihu.com/c_1216656665569013760>) колонка (соответствующая первым 20 дням контента этого проекта) больше подходит для новичков, а другие колонки, такие как «[**Data Thinking and Statistical Thinking**](https. //www.zhihu.com/column/c_1620074540456964096)», „[**Анализ данных на основе Python**](https://www.zhihu.com/column/c_)“, „**Анализ данных на основе Python**](https://www.zhihu.com/column/c_)“, »**Анализ данных на основе Python**](https://www.zhihu.com/column/c_.) 1217746527315496960)», „[**Путешествие говорящего ИИ**](https://www.zhihu.com/column/c_1628900668109946880)“ и др. Постоянно создавая и обновляя, мы рады вашему вниманию, лайкам и комментариям. Если вы хотите бесплатно научиться играть в карты или принять участие в обсуждении вопроса, вы можете присоединиться к следующей группе обмена QQ (три группы плюс одна может быть), пожалуйста, не повторяйте группу, и не публикуйте рекламу и другие порнографические, вульгарные или чувствительного содержания в группе. Если есть необходимость в платном обучении или платной консультации, вы можете добавить мой личный WeChat (микросигнал: **jackfrued**), отметить свое имя и потребности, я окажу вам всю посильную помощь.
>
> <img src="res/python_study_qq_group.png" style="zoom:30%;">
>
> Некоторые из видеороликов, соответствующих этому проекту, были синхронизированы на [Bilibili](https://space.bilibili.com/1177252794), заинтересованные партнеры могут ставить лайки, монеты, обращать внимание, поддерживать в один клик трифекты!
...
### День01~20 - Основы языка Python

#### День01 - [Первое знакомство с Python](./Day01-20/01.Первое_знакомство_с_Python.md)
...
#### Day02 - [Первая программа на Python](./Day01-20/02.Первая_программа_на_Python.md)

1. Инструменты для написания кода
2. Hello world
3. Комментирование кода

#### Day03 - [Переменные в Python](./Day01-20/03.Переменные_в_языке_Python.md)
...
#### Day04 - [Операторы в Python](./Day01-20/04.Операторы_в_языке_Python.md)
...
#### Day05 - [Условный оператор](./Day01-20/05.Условный_оператор.md)
...
#### Day06 - [Структура цикла](./Day01-20/06.循环结构.md)
...
#### Day07 - [Структура ветвлений и циклов в действии](./Day01-20/07.分支和循环结构实战.md)
...
#### Day08 - [Часто используемые структуры данных - список-1](./Day01-20/08.常用数据结构之列表-1.md)

1. 创建列表
2. 列表的运算
3. 元素的遍历

#### Day09 - [Часто используемые структуры данных - список-2](./Day01-20/09.常用数据结构之列表-2.md)
...
#### 第96天：[Тестирование программного обеспечения и автоматизированное тестирование](Day91-100/96.软件测试和自动化测试.md)
...
#### 第97天：[Анализ технических аспектов веб-сайта электронной коммерции](./Day91-100/97.电商网站技术要点剖析.md)
...
#### 第98天：[Внедрение проекта и настройка производительности](./Day91-100/98.项目部署上线和性能调优.md)
