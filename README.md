...
- **Практика делает вас совершеннее.**
...
#### День 11 - [Часто используемые структуры данных - строки](./Day01-20/11.Часто%20используемые%20структуры%20данных%20-%20строки.md)
...
#### День 13 - [Часто используемые структуры данных - словари](./Day01-20/13.Часто%20используемые%20структуры%20данных%20-%20словари.md)

1. Создание и использование словарей
2. Операции со словарями
3. Методы работы со словарями
4. Применение словарей

#### День 14 - [Функции и модули](./Day01-20/14.Функции_и_модули.md)
...
3. Управление функциями с помощью модулей
4. Модули и функции в стандартной библиотеке

#### День 15 - [Практическое применение функций](./Day01-20/15.Практическое%20применение%20функций.md)

1. Пример 1: Случайная CAPTCHA
2. Пример 2: Определение простого числа
3. Пример 3: Наибольший общий делитель и наименьшее общее кратное
4. Пример 4: Статистика данных
5. Пример 5: Выбор случайного числа из двухцветных шаров

#### День 16 - [Расширеное использование функций](./Day01-20/16.Расширенное%20использование%20функций.md)

1. Функции высшего порядка
2. Лямбда-функции
3. Частичные функции

#### День 17 - [Расширенное применение функций](./Day01-20/17.Расширенное%20применение%20функций.md)

1. Декораторы
2. Рекурсивные вызовы

#### День 18 - [Введение в ООП](./Day01-20/18.Введение%20в%20объектно-ориентированное%20программирование.md)

1. Классы и объекты
2. Определение класса
3. Создание и использование объектов
4. Инициализация методов
5. Основы объектно-ориентированного подхода
6. Объектно-ориентированные кейсы
    - Пример 1: Цифровые часы
    - Пример 2: Точки на плоскости

#### День 19 - [Продвинутое ООП](./Day01-20/19.Продвинутое%20объектно-ориентированное%20программирование.md)

1. Декораторы видимости и свойств
2. Динамические свойства
3. Статические методы и методы класса
4. Наследование и полиморфизм

#### День 20 - [Приложения ООП](./Day01-20/20.Приложения%20объектно-ориентированного%20программирования.md)

1. Покерные игры
2. Платежные системы

### День 21~30 - Применение языка Python

#### День 21 - [Чтение, запись файлов и обработка исключений в файлах](./Day21-30/21.Чтение,%20запись%20файлов%20и%20обработка%20исключений.md)

1. Открытие и закрытие файлов
2. Чтение и запись текстовых файлов
3. Механизмы обработки исключений
4. Синтаксис контекстного менеджера
...
#### Day23 - [Чтение и запись CSV-файлов в Python](23.Python读写CSV文件.md)

1. CSV文件介绍
2. 将数据写入CSV文件
3. 从CSV文件读取数据

#### Day24 - [Чтение и запись файлов Excel в Python-1](./Day21-30/24.用Python读写Excel文件-1.md)
...
#### Day25 - [Чтение и запись файлов Excel в Python-2](./Day21-30/25.Python读写Excel文件-2.md)
...
### День 66~80 - Анализ данных на Python
...
### День 100: [Дополнительные материалы](./Day91-100/100.Дополнительные%20материалы.md)
