...
#### Day15 - [Практическое применение функций](./Day01-20/15.函数应用实战.md)
...
#### Day16 - [Расширеное использование функций](./Day01-20/16.函数使用进阶.md)

1. 高阶函数
2. Lambda函数
3. 偏函数

#### Day17 - [Расширенное применение функций](./Day01-20/17.函数高级应用.md)
